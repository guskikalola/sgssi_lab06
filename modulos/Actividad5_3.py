...
def comprobar_ultima_linea(ultima_linea):
    patron = re.compile(r'^[0-9a-f]{8}\t[0-9a-f]{2}\t100')
...
def main(f1,f2):
    ...
    ultima_linea = comprobar_ultima_linea(contenido_fichero_2.decode().splitlines()[num_filas_f1-1])
    valido = empieza_con_cero and empiezan_igual and ultima_linea
